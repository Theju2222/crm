	...
	<div class="" style=" width:1120px;">    		
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" >
				<a href="export.php" type="button" class="btn btn-info btn-xs" style="font-weight: 700;  padding: 10px 35px; font-size: 10px; line-height:1.5; border-radius: 5px;">Export Data</a>
...
<table id="listTickets" class="table table-bordered table-striped"  style="font-size:11px; width:1120px;">
			...
			<thead>
				<tr>
				<th  class="text-center" style="background:rgba(177, 0, 0, 1); color:#ffffff; ">Date</th>
				...
				<th  class="text-center" style="background:rgba(177, 0, 0, 1); color:#ffffff; ">Ticket ID</th>
					...
					<th  class="text-center" style="background:rgba(177, 0, 0, 1); color:#ffffff; ">Date Resolved</th>
